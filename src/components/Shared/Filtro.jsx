...
const Filtro = ()=>{
    ...
    const [name, setName] = useState('prueba');
   

    const  getDataApi = async (name)=>{
        const res = await fetch (`https://api-unas.vercel.app/estilos/estiloName/${name}`);
    ...
    return(<>
      ...
      <div>
        ...
        <ListCharacter characters={characters} className="article_activity"></ListCharacter>
      </div>
    </>)
}
